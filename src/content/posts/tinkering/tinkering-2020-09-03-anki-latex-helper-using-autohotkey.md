...
categories:
  - "tinkering"
date: "2020-09-03T00:26:35+00:00"
...
![ The ALH window within Anki](@assets/images/2020/zRFsKD3.jpg)

![](@assets/images/2020/vJKFLo1.gif)![](@assets/images/2020/JlMRRJM.jpg)

![ The script automatically moves the cursor to the right position.](@assets/images/2020/dcptrav.gif)

![ List of all the included symbols, as seen in the Anki preview screen](@assets/images/2020/hVOBVaZ.jpg)
...
**Note:** ALH stays on top until you use the shortcuts below to minimize or close it.![](@assets/images/2020/1aQiF6R.jpg)

### **Shortcuts:**

### Alt-J to restore the window Alt-K to minimize the window Alt-L to stop the script and close ALH.
...
1. Download the Anki LaTeX Helper.ahk script attached below and simply double click to run it. Voila!
...
1. Prevent ALH from flashing with every button press.   (Thanks to reddit user [Khonkhortisan's](https://www.reddit.com/user/Khonkhortisan/) suggestions.)
1. Replace the text in the buttons with the actual symbols
1. Add more buttons?
...
ButtonSum:
SetTitleMatchMode, 2
ControlSend,, {Raw} \\sum\_{n=-\\infty}^{\\infty} , Add
...
[Download ALH](https://drive.google.com/open?id=1lSg1zZBQn2ekIEEks_eIEnR8DrFt3g3H) Updated: 13/8/19 : [Download ALH\_1.1](https://drive.google.com/open?id=1ZtAtBh47JwxCOTiV7hWqBVYGsvtRYKs4)
